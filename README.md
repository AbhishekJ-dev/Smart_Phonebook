...
- ** Contact Management**: Full CRUD (Create, Read, Update, Delete) functionality for contacts with profile picture support.
...
- ** Secure API**: Protected by Helmet, CORS, and Express Rate Limiters to ensure production-grade security.
